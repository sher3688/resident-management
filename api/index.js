...
var __toESM = (mod, isNodeMode, target) => (target = mod != null ? __create(__getProtoOf(mod)) : {}, __copyProps(
  ...
  // "default" to the CommonJS "__module_exports" for node compatibility.
...
var import_pg_core, parkingTypeEnum, repairStatusEnum, loginMethodEnum, roleEnum, renovationStatusEnum, decorationDepositStatusEnum, operationLogStatusEnum, invitedStatusEnum, residents, coResidents, parkings, parkingPlates, emergencyContacts, repairRequests, auditLogs, passwordUsers, users, renovationApplications, operationLogs, userSessions, invitedUsers, resourceFolders, resourceFiles, CONSTRUCTION_TYPE_RENOVATION, CONSTRUCTION_TYPES_REQUIRING_DEPOSIT, DECORATION_DEPOSIT_STATUS;
var init_schema = __esm({
  "drizzle/schema.ts"() {
    "use strict";
    import_pg_core = require("drizzle-orm/pg-core");
    parkingTypeEnum = (0, import_pg_core.pgEnum)("parking_type", ["car", "motorcycle", "bicycle"]);
    repairStatusEnum = (0, import_pg_core.pgEnum)("repair_status", ["pending", "in_progress", "completed", "cancelled", "resident_self_repair"]);
    loginMethodEnum = (0, import_pg_core.pgEnum)("login_method", ["email", "password"]);
    roleEnum = (0, import_pg_core.pgEnum)("role", ["admin", "user"]);
    renovationStatusEnum = (0, import_pg_core.pgEnum)("renovation_status", ["pending", "approved", "completed", "rejected"]);
    decorationDepositStatusEnum = (0, import_pg_core.pgEnum)("decoration_deposit_status", ["notPaid", "paid", "refunded"]);
    operationLogStatusEnum = (0, import_pg_core.pgEnum)("operation_log_status", ["success", "failure"]);
    invitedStatusEnum = (0, import_pg_core.pgEnum)("invited_status", ["pending", "accepted", "rejected"]);
    residents = (0, import_pg_core.pgTable)("residents", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      // 戶號
      unitNumber: (0, import_pg_core.varchar)("unitNumber", { length: 32 }).notNull(),
      // 區權人（所有人）
      ownerName: (0, import_pg_core.varchar)("ownerName", { length: 64 }).notNull(),
      ownerPhone: (0, import_pg_core.varchar)("ownerPhone", { length: 32 }),
      // 同住人（最多四位）- 保留以支援舊資料
      coResident1Name: (0, import_pg_core.varchar)("coResident1Name", { length: 64 }),
      coResident1Phone: (0, import_pg_core.varchar)("coResident1Phone", { length: 32 }),
      coResident2Name: (0, import_pg_core.varchar)("coResident2Name", { length: 64 }),
      coResident2Phone: (0, import_pg_core.varchar)("coResident2Phone", { length: 32 }),
      coResident3Name: (0, import_pg_core.varchar)("coResident3Name", { length: 64 }),
      coResident3Phone: (0, import_pg_core.varchar)("coResident3Phone", { length: 32 }),
      coResident4Name: (0, import_pg_core.varchar)("coResident4Name", { length: 64 }),
      coResident4Phone: (0, import_pg_core.varchar)("coResident4Phone", { length: 32 }),
      // 車位
      carParkingNumber: (0, import_pg_core.varchar)("carParkingNumber", { length: 32 }),
      carPlateNumber: (0, import_pg_core.varchar)("carPlateNumber", { length: 32 }),
      motorcycleParkingNumber: (0, import_pg_core.varchar)("motorcycleParkingNumber", { length: 32 }),
      motorcyclePlateNumber: (0, import_pg_core.varchar)("motorcyclePlateNumber", { length: 32 }),
      bicycleParkingNumber: (0, import_pg_core.varchar)("bicycleParkingNumber", { length: 32 }),
      // 住戶住所
      address: (0, import_pg_core.text)("address"),
      // 緊急連絡人（第一位）
      emergencyContactName: (0, import_pg_core.varchar)("emergencyContactName", { length: 64 }),
      emergencyContactPhone: (0, import_pg_core.varchar)("emergencyContactPhone", { length: 32 }),
      emergencyContactRelation: (0, import_pg_core.varchar)("emergencyContactRelation", { length: 32 }),
      emergencyContactAddress: (0, import_pg_core.text)("emergencyContactAddress"),
      // 緊急連絡人（第二位）
      emergencyContact2Name: (0, import_pg_core.varchar)("emergencyContact2Name", { length: 64 }),
      emergencyContact2Phone: (0, import_pg_core.varchar)("emergencyContact2Phone", { length: 32 }),
      emergencyContact2Relation: (0, import_pg_core.varchar)("emergencyContact2Relation", { length: 32 }),
      emergencyContact2Address: (0, import_pg_core.text)("emergencyContact2Address"),
      // 坪數
      squareMeters: (0, import_pg_core.varchar)("squareMeters", { length: 32 }),
      // 水號
      waterMeterNumber: (0, import_pg_core.varchar)("waterMeterNumber", { length: 32 }),
      // 電號
      electricityMeterNumber: (0, import_pg_core.varchar)("electricityMeterNumber", { length: 32 }),
      // 入住日期
      moveInDate: (0, import_pg_core.date)("moveInDate"),
      // 備註
    ...
    coResidents = (0, import_pg_core.pgTable)("co_residents", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      residentId: (0, import_pg_core.integer)("residentId").notNull(),
      name: (0, import_pg_core.varchar)("name", { length: 64 }).notNull(),
      phone: (0, import_pg_core.varchar)("phone", { length: 32 }),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull()
    });
    parkings = (0, import_pg_core.pgTable)("parkings", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      residentId: (0, import_pg_core.integer)("residentId").notNull(),
      type: parkingTypeEnum("type").notNull(),
      number: (0, import_pg_core.varchar)("number", { length: 32 }).notNull(),
      plate: (0, import_pg_core.varchar)("plate", { length: 32 }),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull()
    });
    parkingPlates = (0, import_pg_core.pgTable)("parking_plates", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      parkingId: (0, import_pg_core.integer)("parkingId").notNull(),
      plate: (0, import_pg_core.varchar)("plate", { length: 32 }).notNull(),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull()
    });
    emergencyContacts = (0, import_pg_core.pgTable)("emergency_contacts", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      residentId: (0, import_pg_core.integer)("residentId").notNull(),
      name: (0, import_pg_core.varchar)("name", { length: 64 }).notNull(),
      phone: (0, import_pg_core.varchar)("phone", { length: 32 }),
      relationship: (0, import_pg_core.varchar)("relationship", { length: 32 }),
      address: (0, import_pg_core.text)("address"),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull()
    });
    repairRequests = (0, import_pg_core.pgTable)("repair_requests", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      repairDate: (0, import_pg_core.varchar)("repairDate", { length: 32 }).notNull(),
      unitNumber: (0, import_pg_core.varchar)("unitNumber", { length: 32 }).notNull(),
      description: (0, import_pg_core.text)("description").notNull(),
      status: repairStatusEnum("status").default("pending"),
      notes: (0, import_pg_core.text)("notes"),
      completionDate: (0, import_pg_core.varchar)("completionDate", { length: 32 }),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull()
    });
    auditLogs = (0, import_pg_core.pgTable)("audit_logs", {
      ...
      entity: (0, import_pg_core.varchar)("entity", { length: 50 }).notNull(),
      entityId: (0, import_pg_core.integer)("entityId"),
      changes: (0, import_pg_core.text)("changes"),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull()
    });
    passwordUsers = (0, import_pg_core.pgTable)("password_users", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
    ...
    users = (0, import_pg_core.pgTable)("users", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      openId: (0, import_pg_core.varchar)("openId", { length: 255 }).notNull().unique(),
      name: (0, import_pg_core.varchar)("name", { length: 64 }).notNull(),
      ...
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull(),
      lastSignedIn: (0, import_pg_core.timestamp)("lastSignedIn", { withTimezone: true })
    });
    renovationApplications = (0, import_pg_core.pgTable)("renovation_applications", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      unitNumber: (0, import_pg_core.varchar)("unitNumber", { length: 32 }).notNull(),
      applicationDate: (0, import_pg_core.varchar)("applicationDate", { length: 32 }).notNull(),
      constructionStartDate: (0, import_pg_core.varchar)("constructionStartDate", { length: 32 }),
      constructionEndDate: (0, import_pg_core.varchar)("constructionEndDate", { length: 32 }),
      constructionContent: (0, import_pg_core.varchar)("constructionContent", { length: 255 }).notNull(),
      consentLetterPasted: (0, import_pg_core.varchar)("consentLetterPasted", { length: 32 }),
      applicantName: (0, import_pg_core.varchar)("applicantName", { length: 64 }).notNull(),
      applicantPhone: (0, import_pg_core.varchar)("applicantPhone", { length: 32 }).notNull(),
      registeredBy: (0, import_pg_core.varchar)("registeredBy", { length: 64 }),
      status: renovationStatusEnum("status").default("pending"),
      decorationDeposit: (0, import_pg_core.varchar)("decorationDeposit", { length: 32 }),
      decorationDepositStatus: decorationDepositStatusEnum("decorationDepositStatus").default("notPaid"),
      notes: (0, import_pg_core.text)("notes"),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull()
    });
    operationLogs = (0, import_pg_core.pgTable)("operation_logs", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      userId: (0, import_pg_core.integer)("userId").notNull(),
      action: (0, import_pg_core.varchar)("action", { length: 64 }).notNull(),
      module: (0, import_pg_core.varchar)("module", { length: 64 }).notNull(),
      targetId: (0, import_pg_core.integer)("targetId"),
      targetType: (0, import_pg_core.varchar)("targetType", { length: 64 }),
      ...
      errorMessage: (0, import_pg_core.text)("errorMessage"),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull()
    });
    userSessions = (0, import_pg_core.pgTable)("user_sessions", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      userId: (0, import_pg_core.integer)("userId").notNull(),
      sessionToken: (0, import_pg_core.varchar)("sessionToken", { length: 255 }).notNull().unique(),
      ipAddress: (0, import_pg_core.varchar)("ipAddress", { length: 45 }),
      userAgent: (0, import_pg_core.text)("userAgent"),
      deviceName: (0, import_pg_core.varchar)("deviceName", { length: 255 }),
      loginAt: (0, import_pg_core.timestamp)("loginAt", { withTimezone: true }).defaultNow().notNull(),
      lastActivityAt: (0, import_pg_core.timestamp)("lastActivityAt", { withTimezone: true }).defaultNow().notNull(),
      logoutAt: (0, import_pg_core.timestamp)("logoutAt", { withTimezone: true }),
      isActive: (0, import_pg_core.integer)("isActive").default(1).notNull(),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull()
    });
    invitedUsers = (0, import_pg_core.pgTable)("invited_users", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      email: (0, import_pg_core.varchar)("email", { length: 255 }).notNull().unique(),
      name: (0, import_pg_core.varchar)("name", { length: 64 }),
      role: (0, import_pg_core.varchar)("role", { length: 32 }).default("user").notNull(),
      status: (0, import_pg_core.varchar)("status", { length: 32 }).default("pending").notNull(),
      invitedBy: (0, import_pg_core.integer)("invitedBy"),
      invitedAt: (0, import_pg_core.timestamp)("invitedAt", { withTimezone: true }).defaultNow().notNull(),
      acceptedAt: (0, import_pg_core.timestamp)("acceptedAt", { withTimezone: true }),
      notes: (0, import_pg_core.text)("notes"),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull()
    });
    resourceFolders = (0, import_pg_core.pgTable)("resource_folders", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
    ...
    resourceFiles = (0, import_pg_core.pgTable)("resource_files", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      folderId: (0, import_pg_core.integer)("folderId").notNull().references(() => resourceFolders.id, { onDelete: "cascade" }),
      name: (0, import_pg_core.varchar)("name", { length: 255 }).notNull(),
      fileUrl: (0, import_pg_core.text)("fileUrl").notNull(),
      fileSize: (0, import_pg_core.integer)("fileSize"),
      fileType: (0, import_pg_core.varchar)("fileType", { length: 32 }).default("pdf"),
      uploadedBy: (0, import_pg_core.integer)("uploadedBy"),
      createdAt: (0, import_pg_core.timestamp)("createdAt", { withTimezone: true }).defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt", { withTimezone: true }).defaultNow().notNull()
    });
...
async function upsertUser(user) {
  ...
  try {
    ...
    const existing = await db.select().from(users).where((0, import_drizzle_orm.eq)(users.openId, user.openId)).limit(1);
    if (existing.length > 0) {
      ...
      await db.update(users).set(updateData).where((0, import_drizzle_orm.eq)(users.openId, user.openId));
    } else {
  ...
  if (search && search.trim()) {
    ...
    residentsData = await db.select().from(residents).where(
      (0, import_drizzle_orm.or)(
        (0, import_drizzle_orm.like)(residents.unitNumber, keyword),
        (0, import_drizzle_orm.like)(residents.ownerName, keyword),
        (0, import_drizzle_orm.like)(residents.ownerPhone, keyword),
        (0, import_drizzle_orm.like)(residents.coResident1Name, keyword),
        (0, import_drizzle_orm.like)(residents.coResident2Name, keyword),
        (0, import_drizzle_orm.like)(residents.coResident3Name, keyword),
        (0, import_drizzle_orm.like)(residents.coResident4Name, keyword),
        (0, import_drizzle_orm.like)(residents.emergencyContactName, keyword),
        (0, import_drizzle_orm.like)(residents.emergencyContactPhone, keyword)
      )
...
async function getResidentById(id) {
  const db = await getDb();
  if (!db) return void 0;
  const result = await db.select().from(residents).where((0, import_drizzle_orm.eq)(residents.id, id)).limit(1);
  return result[0];
}
...
async function updateResident(id, data) {
  ...
  await db.update(residents).set(updateData).where((0, import_drizzle_orm.eq)(residents.id, id));
  return getResidentById(id);
}
async function deleteResident(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return await db.delete(residents).where((0, import_drizzle_orm.eq)(residents.id, id));
}
async function getParkingsByResidentId(residentId) {
  const db = await getDb();
  if (!db) return [];
  return await db.select().from(parkings).where((0, import_drizzle_orm.eq)(parkings.residentId, residentId));
}
async function getParkingPlatesByParkingId(parkingId) {
  const db = await getDb();
  if (!db) return [];
  return await db.select().from(parkingPlates).where((0, import_drizzle_orm.eq)(parkingPlates.parkingId, parkingId));
}
...
async function updateParking(id, data) {
  ...
  if (!db) throw new Error("Database not available");
  const updateData = { ...data, updatedAt: /* @__PURE__ */ new Date() };
  return await db.update(parkings).set(updateData).where((0, import_drizzle_orm.eq)(parkings.id, id));
}
async function deleteParking(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.delete(parkingPlates).where((0, import_drizzle_orm.eq)(parkingPlates.parkingId, id));
  return await db.delete(parkings).where((0, import_drizzle_orm.eq)(parkings.id, id));
}
...
async function deleteParkingPlate(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return await db.delete(parkingPlates).where((0, import_drizzle_orm.eq)(parkingPlates.id, id));
}
async function getEmergencyContactsByResidentId(residentId) {
  const db = await getDb();
  if (!db) return [];
  try {
    const result = await db.select().from(emergencyContacts).where((0, import_drizzle_orm.eq)(emergencyContacts.residentId, residentId));
...
async function updateEmergencyContact(id, data) {
  ...
  if (!db) throw new Error("Database not available");
  const updateData = { ...data, updatedAt: /* @__PURE__ */ new Date() };
  return await db.update(emergencyContacts).set(updateData).where((0, import_drizzle_orm.eq)(emergencyContacts.id, id));
}
async function deleteEmergencyContact(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return await db.delete(emergencyContacts).where((0, import_drizzle_orm.eq)(emergencyContacts.id, id));
}
async function deleteEmergencyContactsByResidentId(residentId) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return await db.delete(emergencyContacts).where((0, import_drizzle_orm.eq)(emergencyContacts.residentId, residentId));
}
async function listRepairRequests(filters) {
  ...
  if (filters?.status && filters.status !== "all") {
    conditions.push((0, import_drizzle_orm.eq)(repairRequests.status, filters.status));
  }
  if (conditions.length > 0) {
    return await db.select().from(repairRequests).where((0, import_drizzle_orm.and)(...conditions)).orderBy(repairRequests.createdAt);
  }
...
async function getRepairRequestById(id) {
  const db = await getDb();
  if (!db) return void 0;
  const result = await db.select().from(repairRequests).where((0, import_drizzle_orm.eq)(repairRequests.id, id)).limit(1);
  return result[0];
}
...
async function updateRepairRequest(id, data) {
  ...
  if (!db) throw new Error("Database not available");
  const updateData = { ...data, updatedAt: /* @__PURE__ */ new Date() };
  await db.update(repairRequests).set(updateData).where((0, import_drizzle_orm.eq)(repairRequests.id, id));
  return await db.select().from(repairRequests).where((0, import_drizzle_orm.eq)(repairRequests.id, id)).then((rows) => rows[0]);
}
async function deleteRepairRequest(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return await db.delete(repairRequests).where((0, import_drizzle_orm.eq)(repairRequests.id, id));
}
...
async function updateUserRole(openId, role) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return await db.update(users).set({ role, updatedAt: /* @__PURE__ */ new Date() }).where((0, import_drizzle_orm.eq)(users.openId, openId));
}
...
async function getOperationLogsByUserId(userId, limit = 100) {
  ...
  try {
    const logs = await db.select().from(operationLogs).where((0, import_drizzle_orm.eq)(operationLogs.userId, userId)).orderBy((t2) => t2.createdAt).limit(limit);
    return logs;
  } catch (error) {
...
async function getOperationLogsByModule(module2, limit = 100) {
  const db = await getDb();
  if (!db) {
    console.warn("[Database] Cannot get operation logs: database not available");
    return [];
  ...
  try {
    const logs = await db.select().from(operationLogs).where((0, import_drizzle_orm.eq)(operationLogs.module, module2)).orderBy((t2) => t2.createdAt).limit(limit);
    return logs;
  } catch (error) {
    console.error("[Database] Failed to get operation logs:", error);
    return [];
...
async function getActiveSessionsByUserId(userId) {
  ...
  try {
    const sessions = await db.select().from(userSessions).where((0, import_drizzle_orm.and)((0, import_drizzle_orm.eq)(userSessions.userId, userId), (0, import_drizzle_orm.eq)(userSessions.isActive, 1)));
    return sessions;
  } catch (error) {
...
async function logoutUserSession(sessionId) {
  ...
  try {
    await db.update(userSessions).set({ isActive: 0, logoutAt: /* @__PURE__ */ new Date() }).where((0, import_drizzle_orm.eq)(userSessions.id, sessionId));
  } catch (error) {
...
async function forceLogoutAllSessions(userId) {
  ...
  try {
    await db.update(userSessions).set({ isActive: 0, logoutAt: /* @__PURE__ */ new Date() }).where((0, import_drizzle_orm.eq)(userSessions.userId, userId));
  } catch (error) {
...
async function getAllInvitedUsers() {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return db.select().from(invitedUsers).orderBy((0, import_drizzle_orm.desc)(invitedUsers.invitedAt));
}
async function getInvitedUserByEmail(email) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  const result = await db.select().from(invitedUsers).where((0, import_drizzle_orm.eq)(invitedUsers.email, email));
  return result[0];
}
async function updateInvitedUser(id, updates) {
  ...
  await db.update(invitedUsers).set(updateData).where((0, import_drizzle_orm.eq)(invitedUsers.id, id));
  return getInvitedUserById(id);
}
async function getInvitedUserById(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  const result = await db.select().from(invitedUsers).where((0, import_drizzle_orm.eq)(invitedUsers.id, id));
  return result[0];
}
async function deleteInvitedUser(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.delete(invitedUsers).where((0, import_drizzle_orm.eq)(invitedUsers.id, id));
  return true;
}
...
async function listRenovationApplications(filters) {
  ...
  const conditions = [];
  if (filters?.status && filters.status !== "all") {
    conditions.push((0, import_drizzle_orm.eq)(renovationApplications.status, filters.status));
  }
  if (conditions.length > 0) {
    return await db.select().from(renovationApplications).where((0, import_drizzle_orm.and)(...conditions)).orderBy(renovationApplications.createdAt);
  }
...
async function getRenovationApplicationById(id) {
  const db = await getDb();
  if (!db) return void 0;
  const result = await db.select().from(renovationApplications).where((0, import_drizzle_orm.eq)(renovationApplications.id, id)).limit(1);
  return result[0];
}
...
async function updateRenovationApplication(id, data) {
  ...
  if (!db) throw new Error("Database not available");
  const updateData = { ...data, updatedAt: /* @__PURE__ */ new Date() };
  await db.update(renovationApplications).set(updateData).where((0, import_drizzle_orm.eq)(renovationApplications.id, id));
  return await getRenovationApplicationById(id);
}
async function deleteRenovationApplication(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return await db.delete(renovationApplications).where((0, import_drizzle_orm.eq)(renovationApplications.id, id));
}
...
async function getResourceFolderById(id) {
  const db = await getDb();
  if (!db) return void 0;
  const result = await db.select().from(resourceFolders).where((0, import_drizzle_orm.eq)(resourceFolders.id, id)).limit(1);
  return result[0];
}
...
async function updateResourceFolder(id, data) {
  ...
  if (!db) throw new Error("Database not available");
  const updateData = { ...data, updatedAt: /* @__PURE__ */ new Date() };
  await db.update(resourceFolders).set(updateData).where((0, import_drizzle_orm.eq)(resourceFolders.id, id));
  return await getResourceFolderById(id);
}
async function deleteResourceFolder(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.delete(resourceFiles).where((0, import_drizzle_orm.eq)(resourceFiles.folderId, id));
  return await db.delete(resourceFolders).where((0, import_drizzle_orm.eq)(resourceFolders.id, id));
}
async function listResourceFilesByFolderId(folderId) {
  const db = await getDb();
  if (!db) return [];
  return db.select().from(resourceFiles).where((0, import_drizzle_orm.eq)(resourceFiles.folderId, folderId)).orderBy(resourceFiles.createdAt);
}
async function getResourceFileById(id) {
  const db = await getDb();
  if (!db) return void 0;
  const result = await db.select().from(resourceFiles).where((0, import_drizzle_orm.eq)(resourceFiles.id, id)).limit(1);
  return result[0];
}
...
async function deleteResourceFile(id) {
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  return await db.delete(resourceFiles).where((0, import_drizzle_orm.eq)(resourceFiles.id, id));
}
var import_drizzle_orm, import_node_postgres, import_pg, _pool, _db;
var init_db = __esm({
  "server/db.ts"() {
    "use strict";
...
__module_exports = __toCommonJS(index_exports);
var import_config = require("dotenv/config");
var import_express4 = __toESM(require("express"), 1);
var import_http = require("http");
var import_net = __toESM(require("net"), 1);
var import_express5 = require("@trpc/server/adapters/express");
...
async function authenticatePasswordUser(username, password) {
  try {
    const db = await getDb();
    if (!db) return null;
    const userResult = await db.select().from(users).where((0, import_drizzle_orm2.eq)(users.name, username)).limit(1);
    const user = userResult[0];
    if (!user) {
      return null;
    }
    const passwordResult = await db.select().from(passwordUsers).where((0, import_drizzle_orm2.eq)(passwordUsers.userId, user.id)).limit(1);
    const passwordRecord = passwordResult[0];
    if (!passwordRecord) {
      return null;
    }
    const isValid = await import_bcryptjs.default.compare(password, passwordRecord.passwordHash);
    if (!isValid) {
      return null;
    }
    return {
...
async function registerPasswordUser(username, password, name, email, role = "user") {
  try {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    const existingResult = await db.select().from(users).where((0, import_drizzle_orm2.eq)(users.name, username)).limit(1);
    ...
    const newUserResult = await db.select().from(users).where((0, import_drizzle_orm2.eq)(users.name, username)).limit(1);
...
async function getPasswordUser(userId) {
  try {
    const db = await getDb();
    if (!db) return null;
    const userResult = await db.select().from(users).where((0, import_drizzle_orm2.eq)(users.id, userId)).limit(1);
    const user = userResult[0];
    if (!user) {
      return null;
    }
...
async function updatePasswordUser(userId, updates) {
  try {
    ...
    await db.update(users).set(updateData).where((0, import_drizzle_orm2.eq)(users.id, userId));
    if (updates.password) {
      const passwordHash = await import_bcryptjs.default.hash(updates.password, 10);
      await db.update(passwordUsers).set({ passwordHash, updatedAt: now }).where((0, import_drizzle_orm2.eq)(passwordUsers.userId, userId));
    }
...
async function deletePasswordUser(userId) {
  try {
    const db = await getDb();
    if (!db) return false;
    await db.delete(passwordUsers).where((0, import_drizzle_orm2.eq)(passwordUsers.userId, userId));
...
async function initializeDemoUsers() {
  try {
    ...
    let adminResult;
    try {
      adminResult = await db.select().from(users).where((0, import_drizzle_orm2.eq)(users.name, "admin")).limit(1);
    } catch (e) {
    ...
    let userResult;
    try {
      userResult = await db.select().from(users).where((0, import_drizzle_orm2.eq)(users.name, "user")).limit(1);
    } catch (e) {
...
var passwordAuthRouter = router({
  ...
  login: publicProcedure.input(
    import_zod2.z.object({
      username: import_zod2.z.string().min(3, "\u4F7F\u7528\u8005\u540D\u7A31\u81F3\u5C11 3 \u500B\u5B57\u7B26"),
      password: import_zod2.z.string().min(1, "\u5BC6\u78BC\u4E0D\u80FD\u70BA\u7A7A")
    })
  ...
  register: publicProcedure.input(
    import_zod2.z.object({
      username: import_zod2.z.string().min(3, "\u4F7F\u7528\u8005\u540D\u7A31\u81F3\u5C11 3 \u500B\u5B57\u7B26"),
      password: import_zod2.z.string().min(6, "\u5BC6\u78BC\u81F3\u5C11 6 \u500B\u5B57\u7B26"),
      name: import_zod2.z.string().min(1, "\u540D\u7A31\u4E0D\u80FD\u70BA\u7A7A"),
      role: import_zod2.z.enum(["admin", "user"]).optional().default("user")
    })
  ).mutation(async ({ input }) => {
    try {
...
var passwordUserManagementRouter = router({
  ...
  create: adminProcedure.input(
    import_zod3.z.object({
      username: import_zod3.z.string().min(3, "\u4F7F\u7528\u8005\u540D\u7A31\u81F3\u5C11 3 \u500B\u5B57\u7B26"),
      password: import_zod3.z.string().min(6, "\u5BC6\u78BC\u81F3\u5C11 6 \u500B\u5B57\u7B26"),
      name: import_zod3.z.string().min(1, "\u540D\u7A31\u4E0D\u80FD\u70BA\u7A7A"),
  ...
  update: adminProcedure.input(
    import_zod3.z.object({
      ...
      role: import_zod3.z.enum(["admin", "user"]).optional(),
   ...
   * 刪除帳密使用者
   */
  delete: adminProcedure.input(import_zod3.z.object({ id: import_zod3.z.string() })).mutation(async ({ input }) => {
   ...
   * 取得單個帳密使用者
   */
  getById: adminProcedure.input(import_zod3.z.object({ id: import_zod3.z.string() })).query(async ({ input }) => {
...
var LOG_DIR = import_path.default.join(process.cwd(), ".audit-logs");
function ensureLogDir() {
  if (!import_fs.default.existsSync(LOG_DIR)) {
    import_fs.default.mkdirSync(LOG_DIR, { recursive: true });
  }
}
function logAuditEvent(entry) {
  ensureLogDir();
  const logFile = import_path.default.join(LOG_DIR, `audit-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.jsonl`);
...
function readAuditLogs(options) {
  ensureLogDir();
  const logs = [];
  const files = import_fs.default.readdirSync(LOG_DIR).sort().reverse();
  for (const file of files) {
    if (!file.endsWith(".jsonl")) continue;
    const filePath = import_path.default.join(LOG_DIR, file);
...
var auditLogRouter = router({
  ...
  list: protectedProcedure.input(
    import_zod4.z.object({
      ...
      userId: import_zod4.z.number().optional(),
      entity: import_zod4.z.enum(["resident", "repair_request", "user"]).optional(),
      action: import_zod4.z.enum(["CREATE", "UPDATE", "DELETE"]).optional(),
      sortBy: import_zod4.z.enum(["timestamp", "userId", "action", "entity"]).default("timestamp"),
      sortOrder: import_zod4.z.enum(["asc", "desc"]).default("desc"),
   ...
   * 查詢特定使用者的操作日誌
   */
  byUser: protectedProcedure.input(import_zod4.z.object({ userId: import_zod4.z.number(), limit: import_zod4.z.number().default(50) })).query(({ ctx, input }) => {
    requireAdmin(ctx);
  ...
  byEntity: protectedProcedure.input(
    import_zod4.z.object({
      entity: import_zod4.z.enum(["resident", "repair_request", "user"]),
      limit: import_zod4.z.number().default(50)
    })
  ).query(({ ctx, input }) => {
    requireAdmin(ctx);
    const logs = readAuditLogs({
...
init_db();
var repairRequestInput = import_zod5.z.object({
  unitNumber: import_zod5.z.string().min(1, "\u6236\u865F\u70BA\u5FC5\u586B"),
  description: import_zod5.z.string().min(1, "\u63CF\u8FF0\u70BA\u5FC5\u586B"),
  status: import_zod5.z.enum(["pending", "in_progress", "completed", "cancelled", "resident_self_repair"]).default("pending"),
  repairDate: import_zod5.z.string().optional(),
  completionDate: import_zod5.z.string().optional().nullable(),
...
var repairRequestsWithAuditRouter = router({
  ...
  get: protectedProcedure.input(import_zod5.z.object({ id: import_zod5.z.number() })).query(({ ctx, input }) => {
  ...
  update: protectedProcedure.input(import_zod5.z.object({ id: import_zod5.z.number(), unitNumber: import_zod5.z.string().min(1), description: import_zod5.z.string().min(1), status: import_zod5.z.enum(["pending", "in_progress", "completed", "cancelled", "resident_self_repair"]).optional(), repairDate: import_zod5.z.string().optional(), completionDate: import_zod5.z.string().optional().nullable(), notes: import_zod5.z.string().optional().nullable() })).mutation(async ({ ctx, input }) => {
    const user = ctx.user;
  ...
  delete: protectedProcedure.input(import_zod5.z.object({ id: import_zod5.z.number() })).mutation(async ({ ctx, input }) => {
    const user = ctx.user;
    const before = await getRepairRequestById(input.id);
...
init_db();
var emergencyContactInput = import_zod6.z.object({
  id: import_zod6.z.number().optional(),
  name: import_zod6.z.string().min(1, "\u7DCA\u6025\u806F\u7D61\u4EBA\u59D3\u540D\u70BA\u5FC5\u586B"),
  phone: import_zod6.z.string().optional().nullable(),
  relation: import_zod6.z.string().optional().nullable(),
  address: import_zod6.z.string().optional().nullable()
});
var residentInput = import_zod6.z.object({
  unitNumber: import_zod6.z.string().min(1, "\u6236\u865F\u70BA\u5FC5\u586B"),
  ownerName: import_zod6.z.string().min(1, "\u5340\u6B0A\u4EBA\u59D3\u540D\u70BA\u5FC5\u586B"),
  ownerPhone: import_zod6.z.string().optional().nullable(),
  coResident1Name: import_zod6.z.string().optional().nullable(),
  coResident1Phone: import_zod6.z.string().optional().nullable(),
  coResident2Name: import_zod6.z.string().optional().nullable(),
  coResident2Phone: import_zod6.z.string().optional().nullable(),
  coResident3Name: import_zod6.z.string().optional().nullable(),
  coResident3Phone: import_zod6.z.string().optional().nullable(),
  coResident4Name: import_zod6.z.string().optional().nullable(),
  coResident4Phone: import_zod6.z.string().optional().nullable(),
  carParkingNumber: import_zod6.z.string().optional().nullable(),
  carPlateNumber: import_zod6.z.string().optional().nullable(),
  motorcycleParkingNumber: import_zod6.z.string().optional().nullable(),
  motorcyclePlateNumber: import_zod6.z.string().optional().nullable(),
  bicycleParkingNumber: import_zod6.z.string().optional().nullable(),
  address: import_zod6.z.string().optional().nullable(),
  emergencyContactName: import_zod6.z.string().optional().nullable(),
  emergencyContactPhone: import_zod6.z.string().optional().nullable(),
  emergencyContactRelation: import_zod6.z.string().optional().nullable(),
  emergencyContactAddress: import_zod6.z.string().optional().nullable(),
  emergencyContact2Name: import_zod6.z.string().optional().nullable(),
  emergencyContact2Phone: import_zod6.z.string().optional().nullable(),
  emergencyContact2Relation: import_zod6.z.string().optional().nullable(),
  emergencyContact2Address: import_zod6.z.string().optional().nullable(),
  squareMeters: import_zod6.z.string().optional().nullable(),
  waterMeterNumber: import_zod6.z.string().optional().nullable(),
  electricityMeterNumber: import_zod6.z.string().optional().nullable(),
  moveInDate: import_zod6.z.string().optional().nullable(),
  notes: import_zod6.z.string().optional().nullable(),
  emergencyContacts: import_zod6.z.array(emergencyContactInput).optional()
});
var residentsWithAuditRouter = router({
  ...
  get: protectedProcedure.input(import_zod6.z.object({ id: import_zod6.z.number() })).query(async ({ ctx, input }) => {
    try {
  ...
  update: protectedProcedure.input(import_zod6.z.object({ id: import_zod6.z.number(), ...residentInput.shape })).mutation(async ({ ctx, input }) => {
  ...
  delete: protectedProcedure.input(import_zod6.z.object({ id: import_zod6.z.number() })).mutation(async ({ ctx, input }) => {
    const user = ctx.user;
    const before = await getResidentById(input.id);
  ...
  validateUnitNumber: protectedProcedure.input(import_zod6.z.object({ unitNumber: import_zod6.z.string() })).query(({ input }) => {
  ...
  importBatch: protectedProcedure.input(import_zod6.z.object({ residents: import_zod6.z.array(residentInput) })).mutation(async ({ ctx, input }) => {
    const user = ctx.user;
    const results = [];
...
var accountManagementRouter = router({
  ...
  create: protectedProcedure.input(
    import_zod7.z.object({
      ...
      role: import_zod7.z.enum(["admin", "user"])
    })
  ).mutation(async ({ input, ctx }) => {
    if (ctx.user?.role !== "admin") {
      throw new import_server4.TRPCError({ code: "FORBIDDEN" });
  ...
  update: protectedProcedure.input(
    import_zod7.z.object({
      ...
      role: import_zod7.z.enum(["admin", "user"]).optional(),
      password: import_zod7.z.string().min(6).optional().or(import_zod7.z.literal("")),
  ...
  // 停用帳號
  deactivate: protectedProcedure.input(import_zod7.z.object({ id: import_zod7.z.number() })).mutation(async ({ input, ctx }) => {
    if (ctx.user?.role !== "admin") {
      throw new import_server4.TRPCError({ code: "FORBIDDEN" });
    }
    const user = await getPasswordUser(input.id);
  ...
  // 啟用帳號
  activate: protectedProcedure.input(import_zod7.z.object({ id: import_zod7.z.number() })).mutation(async ({ input, ctx }) => {
    if (ctx.user?.role !== "admin") {
      throw new import_server4.TRPCError({ code: "FORBIDDEN" });
    }
    const user = await getPasswordUser(input.id);
...
var renovationApplicationsRouter = router({
  ...
  getById: protectedProcedure.input(import_zod8.z.object({ id: import_zod8.z.number() })).query(async ({ input }) => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    const result = await db.select().from(renovationApplications).where((0, import_drizzle_orm3.eq)(renovationApplications.id, input.id)).limit(1);
    return result[0] || null;
  }),
  create: protectedProcedure.input(
    import_zod8.z.object({
      unitNumber: import_zod8.z.string().min(1),
      applicationDate: import_zod8.z.string().min(1),
      constructionStartDate: import_zod8.z.string().optional().nullable(),
      constructionEndDate: import_zod8.z.string().optional().nullable(),
      constructionContent: import_zod8.z.string().min(1),
      consentLetterPasted: import_zod8.z.string().optional().nullable(),
      applicantName: import_zod8.z.string().min(1),
      applicantPhone: import_zod8.z.string().min(1),
      registeredBy: import_zod8.z.string().optional().nullable(),
      status: import_zod8.z.enum(["pending", "approved", "completed", "rejected"]).default("pending"),
      decorationDeposit: import_zod8.z.string().optional().nullable(),
      decorationDepositStatus: import_zod8.z.enum(["notPaid", "paid", "refunded"]).optional().default("notPaid"),
  ...
  update: protectedProcedure.input(
    import_zod8.z.object({
      ...
      applicantPhone: import_zod8.z.string().min(1),
      registeredBy: import_zod8.z.string().optional().nullable(),
      status: import_zod8.z.enum(["pending", "approved", "completed", "rejected"]),
      decorationDeposit: import_zod8.z.string().optional().nullable(),
      decorationDepositStatus: import_zod8.z.enum(["notPaid", "paid", "refunded"]).optional(),
      notes: import_zod8.z.string().optional().nullable()
    })
  ).mutation(async ({ input }) => {
    const db = await getDb();
    ...
    }).where((0, import_drizzle_orm3.eq)(renovationApplications.id, id));
    return result;
  }),
  delete: protectedProcedure.input(import_zod8.z.object({ id: import_zod8.z.number() })).mutation(async ({ input }) => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    const result = await db.delete(renovationApplications).where((0, import_drizzle_orm3.eq)(renovationApplications.id, input.id));
    return result;
  })
});
...
var resourceLibraryRouter = router({
  ...
  listFolders: protectedProcedure.query(async () => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    const folders = await db.select().from(resourceFolders).orderBy((0, import_drizzle_orm4.desc)(resourceFolders.createdAt));
    return folders;
  }),
  createFolder: protectedProcedure.input(
    import_zod9.z.object({
      name: import_zod9.z.string().min(1, "\u6587\u4EF6\u593E\u540D\u7A31\u4E0D\u80FD\u70BA\u7A7A"),
  ...
  updateFolder: protectedProcedure.input(
    ...
    const result = await db.update(resourceFolders).set({
      name: input.name,
      description: input.description
    }).where((0, import_drizzle_orm4.eq)(resourceFolders.id, input.id));
    return result;
  }),
  deleteFolder: protectedProcedure.input(import_zod9.z.object({ id: import_zod9.z.number() })).mutation(async ({ input }) => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    const result = await db.delete(resourceFolders).where((0, import_drizzle_orm4.eq)(resourceFolders.id, input.id));
    return result;
  }),
  // 檔案操作
  listFiles: protectedProcedure.input(import_zod9.z.object({ folderId: import_zod9.z.number() })).query(async ({ input }) => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    const files = await db.select().from(resourceFiles).where((0, import_drizzle_orm4.eq)(resourceFiles.folderId, input.folderId)).orderBy((0, import_drizzle_orm4.desc)(resourceFiles.createdAt));
    return files;
  }),
  createFile: protectedProcedure.input(
    import_zod9.z.object({
      folderId: import_zod9.z.number(),
      name: import_zod9.z.string().min(1, "\u6A94\u6848\u540D\u7A31\u4E0D\u80FD\u70BA\u7A7A"),
      fileUrl: import_zod9.z.string().min(1, "\u6A94\u6848 URL \u4E0D\u80FD\u70BA\u7A7A"),
      fileSize: import_zod9.z.number().optional(),
      fileType: import_zod9.z.string().default("pdf")
    })
  ).mutation(async ({ input, ctx }) => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
  ...
  updateFile: protectedProcedure.input(
    import_zod9.z.object({
      id: import_zod9.z.number(),
      name: import_zod9.z.string().min(1, "\u6A94\u6848\u540D\u7A31\u4E0D\u80FD\u70BA\u7A7A"),
      fileUrl: import_zod9.z.string().min(1, "\u6A94\u6848 URL \u4E0D\u80FD\u70BA\u7A7A").optional()
    })
  ).mutation(async ({ input }) => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    ...
    const result = await db.update(resourceFiles).set(updateData).where((0, import_drizzle_orm4.eq)(resourceFiles.id, input.id));
    return result;
  }),
  deleteFile: protectedProcedure.input(import_zod9.z.object({ id: import_zod9.z.number() })).mutation(async ({ input }) => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    const result = await db.delete(resourceFiles).where((0, import_drizzle_orm4.eq)(resourceFiles.id, input.id));
    return result;
  }),
  // 獲取檔案詳情
  getFile: protectedProcedure.input(import_zod9.z.object({ id: import_zod9.z.number() })).query(async ({ input }) => {
    const db = await getDb();
    if (!db) throw new Error("Database not available");
    const file = await db.select().from(resourceFiles).where((0, import_drizzle_orm4.eq)(resourceFiles.id, input.id));
    return file[0] || null;
  })
});

// server/routers.ts
var residentInput2 = import_zod10.z.object({
  unitNumber: import_zod10.z.string().min(1, "\u6236\u865F\u70BA\u5FC5\u586B"),
  ownerName: import_zod10.z.string().min(1, "\u5340\u6B0A\u4EBA\u59D3\u540D\u70BA\u5FC5\u586B"),
  ownerPhone: import_zod10.z.string().optional().nullable(),
  coResident1Name: import_zod10.z.string().optional().nullable(),
  coResident1Phone: import_zod10.z.string().optional().nullable(),
  coResident2Name: import_zod10.z.string().optional().nullable(),
  coResident2Phone: import_zod10.z.string().optional().nullable(),
  coResident3Name: import_zod10.z.string().optional().nullable(),
  coResident3Phone: import_zod10.z.string().optional().nullable(),
  coResident4Name: import_zod10.z.string().optional().nullable(),
  coResident4Phone: import_zod10.z.string().optional().nullable(),
  carParkingNumber: import_zod10.z.string().optional().nullable(),
  carPlateNumber: import_zod10.z.string().optional().nullable(),
  motorcycleParkingNumber: import_zod10.z.string().optional().nullable(),
  motorcyclePlateNumber: import_zod10.z.string().optional().nullable(),
  bicycleParkingNumber: import_zod10.z.string().optional().nullable(),
  address: import_zod10.z.string().optional().nullable(),
  emergencyContactName: import_zod10.z.string().optional().nullable(),
  emergencyContactPhone: import_zod10.z.string().optional().nullable(),
  emergencyContactRelation: import_zod10.z.string().optional().nullable(),
  emergencyContactAddress: import_zod10.z.string().optional().nullable(),
  emergencyContact2Name: import_zod10.z.string().optional().nullable(),
  emergencyContact2Phone: import_zod10.z.string().optional().nullable(),
  emergencyContact2Relation: import_zod10.z.string().optional().nullable(),
  emergencyContact2Address: import_zod10.z.string().optional().nullable(),
  squareMeters: import_zod10.z.string().optional().nullable(),
  waterMeterNumber: import_zod10.z.string().optional().nullable(),
  electricityMeterNumber: import_zod10.z.string().optional().nullable(),
  moveInDate: import_zod10.z.string().regex(/^\d{4}-\d{2}-\d{2}$/, "\u5165\u4F4F\u65E5\u671F\u683C\u5F0F\u61C9\u70BA YYYY-MM-DD").optional().nullable(),
  notes: import_zod10.z.string().optional().nullable()
});
var repairRequestInput2 = import_zod10.z.object({
  repairDate: import_zod10.z.string().regex(/^\d{4}-\d{2}-\d{2}$/, "\u5831\u4FEE\u65E5\u671F\u683C\u5F0F\u61C9\u70BA YYYY-MM-DD"),
  unitNumber: import_zod10.z.string().min(1, "\u6236\u865F\u70BA\u5FC5\u586B"),
  reporterName: import_zod10.z.string().optional().nullable(),
  description: import_zod10.z.string().min(1, "\u72C0\u6CC1\u63CF\u8FF0\u70BA\u5FC5\u586B"),
  location: import_zod10.z.string().optional().nullable(),
  status: import_zod10.z.enum(["pending", "in_progress", "completed", "cancelled"]).default("pending"),
  handlerNotes: import_zod10.z.string().optional().nullable(),
  completedDate: import_zod10.z.string().regex(/^\d{4}-\d{2}-\d{2}$/, "\u5B8C\u6210\u65E5\u671F\u683C\u5F0F\u61C9\u70BA YYYY-MM-DD").optional().nullable()
});
var residentsRouter = router({
  list: publicProcedure.input(import_zod10.z.object({ search: import_zod10.z.string().optional() }).optional()).query(async ({ input }) => {
    return listResidents(input?.search);
  }),
  getById: publicProcedure.input(import_zod10.z.object({ id: import_zod10.z.number() })).query(async ({ input }) => {
  ...
  update: publicProcedure.input(import_zod10.z.object({ id: import_zod10.z.number(), data: residentInput2.partial() })).mutation(async ({ input }) => {
    const data = {
      ...input.data,
  ...
  delete: publicProcedure.input(import_zod10.z.object({ id: import_zod10.z.number() })).mutation(async ({ input }) => {
    await deleteResident(input.id);
    return { success: true };
  }),
  ...
  validateUnitNumber: publicProcedure.input(import_zod10.z.object({ unitNumber: import_zod10.z.string(), excludeId: import_zod10.z.number().optional() })).query(async ({ input }) => {
  ...
  importBatch: publicProcedure.input(import_zod10.z.object({ residents: import_zod10.z.array(residentInput2) })).mutation(async ({ input }) => {
...
var repairRequestsRouter = router({
  list: publicProcedure.input(import_zod10.z.object({
    status: import_zod10.z.string().optional(),
    unitNumber: import_zod10.z.string().optional()
  ...
  update: publicProcedure.input(import_zod10.z.object({ id: import_zod10.z.number(), data: repairRequestInput2.partial() })).mutation(async ({ input }) => {
...
var adminRouter = router({
  ...
  updateUserRole: adminProcedure.input(import_zod10.z.object({ openId: import_zod10.z.string(), role: import_zod10.z.enum(["admin", "user"]) })).mutation(async ({ input }) => {
  ...
  restoreResidents: adminProcedure.input(import_zod10.z.object({ data: import_zod10.z.array(import_zod10.z.any()) })).mutation(async ({ input }) => {
    const result = await restoreResidents(input.data);
    return result;
  }),
  restoreRepairRequests: adminProcedure.input(import_zod10.z.object({ data: import_zod10.z.array(import_zod10.z.any()) })).mutation(async ({ input }) => {
  ...
  getOperationLogs: adminProcedure.input(import_zod10.z.object({ limit: import_zod10.z.number().default(50) })).query(async ({ input }) => {
    const db = await getDb();
    if (!db) return [];
  ...
  forceLogoutUser: adminProcedure.input(import_zod10.z.object({ sessionId: import_zod10.z.number() })).mutation(async ({ input }) => {
...
var invitedUsersRouter = router({
  ...
  add: adminProcedure.input(
    import_zod10.z.object({
      email: import_zod10.z.string().email("\u90F5\u7BB1\u683C\u5F0F\u4E0D\u6B63\u78BA"),
      name: import_zod10.z.string().optional(),
      role: import_zod10.z.enum(["admin", "user"]).default("user"),
   ...
   * 刪除受邀人員
   */
  delete: adminProcedure.input(import_zod10.z.object({ id: import_zod10.z.number() })).mutation(async ({ input, ctx }) => {
    try {
   ...
   * 検查郵箱是否被邀請
   */
  checkEmail: publicProcedure.input(import_zod10.z.object({ email: import_zod10.z.string().email() })).query(async ({ input }) => {
  ...
  updateStatus: adminProcedure.input(
    import_zod10.z.object({
      ...
      status: import_zod10.z.enum(["pending", "accepted", "rejected"])
    })
  ).mutation(async ({ input, ctx }) => {
    try {
      const invited = await getInvitedUserById(input.id);
...
function serveStatic(app) {
  let distPath;
  const vercelPath = import_path2.default.resolve(process.env.LAMBDA_TASK_ROOT || __dirname, "public");
  const localPath = import_path2.default.resolve(process.cwd(), "dist", "public");
  if (import_fs2.default.existsSync(vercelPath)) {
    distPath = vercelPath;
    console.log(`[Server] Using static files from: ${distPath}`);
  } else if (import_fs2.default.existsSync(localPath)) {
    distPath = localPath;
    console.log(`[Server] Using static files from: ${distPath}`);
  } else {
    distPath = vercelPath;
...
init_db();
var residentsExportRouter = (0, import_express2.Router)();
...
function createApp() {
  ...
  app.use(
    "/api/trpc",
    (0, import_express5.createExpressMiddleware)({
      router: appRouter,
      createContext
    })
  );
